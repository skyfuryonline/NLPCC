...
args = TrainingArguments(
    output_dir='./results', num_train_epochs=epoch,
    do_train=True, per_device_train_batch_size=4,
    gradient_accumulation_steps=16, logging_steps=50,
    save_strategy="epoch", save_total_limit=1,
    report_to=["wandb"], bf16=True,
    learning_rate=0.0005, lr_scheduler_type='constant',
